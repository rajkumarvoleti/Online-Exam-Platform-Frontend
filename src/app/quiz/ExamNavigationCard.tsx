    ...
    <Card sx={styles}>
      <Box className="container1">
        ...
        <Box className="questionInfo">
          <QuestionResponseInfo type="responded" number={5} text={"Responded"}  />
          <QuestionResponseInfo type="notVisited" number={1} text={"Not Visited"}  />
          <QuestionResponseInfo type="notResponded" number={0} text={"Not Responded"}  />
          <QuestionResponseInfo type="markedForReview" number={2} text={"Marked for Review"}  />
          <QuestionResponseInfo type="respondedAndMarked" number={1} text={"Responded and Marked for review"}  />
        </Box>
      </Box>
